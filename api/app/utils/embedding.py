...
def cosine_similarity(vec1: List[float] | np.ndarray, vec2: List[float] | np.ndarray) -> float | np.ndarray:
    vec1 = np.array(vec1)
    vec2 = np.array(vec2)
    if vec1.ndim == 1:
...
def cosine_similarity_single(vec1: List[float] | np.ndarray, vec2: List[float] | np.ndarray) -> float:
    vec1 = np.array(vec1)
    vec2 = np.array(vec2)
